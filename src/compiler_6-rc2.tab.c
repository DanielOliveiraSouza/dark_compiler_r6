...
#line 6 "compiler_6-rc2.y" /* yacc.c:339  */
...
#line 84 "compiler_6-rc2.tab.c" /* yacc.c:339  */
...
/* In a future release of Bison, this section will be replaced
   by #include "compiler_6-rc2.tab.h".  */
#ifndef YY_YY_COMPILER_6_RC2_TAB_H_INCLUDED
# define YY_YY_COMPILER_6_RC2_TAB_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
union YYSTYPE
{
#line 23 "compiler_6-rc2.y" /* yacc.c:355  */

	int inteiro;
	char string[2048];

#line 164 "compiler_6-rc2.tab.c" /* yacc.c:355  */
};
...
#endif /* !YY_YY_COMPILER_6_RC2_TAB_H_INCLUDED  */

/* Copy the second part of user declarations.  */

#line 179 "compiler_6-rc2.tab.c" /* yacc.c:358  */
...
static const char *const yytname[] =
{
  ...
  "ERROLEXICO", "DELIMITADOR", "$accept", "programa", "bloco", "comandos",
  "comando_escrita", "declaracoes", "declaracao", YY_NULLPTR
};
#endif
...
{
       4,     3,     9,    12,    13,     5,     6,    14,    15
};

static const yytype_uint8 yycheck[] =
{
      20,     0,    10,     4,     4,    25,    26,     4,    21
};
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 77 "compiler_6-rc2.y" /* yacc.c:1646  */
    { }
#line 1261 "compiler_6-rc2.tab.c" /* yacc.c:1646  */
    break;

  case 3:
#line 81 "compiler_6-rc2.y" /* yacc.c:1646  */
    { }
#line 1267 "compiler_6-rc2.tab.c" /* yacc.c:1646  */
    break;

  case 6:
#line 90 "compiler_6-rc2.y" /* yacc.c:1646  */
    { Write_variable((yyvsp[0].string));}
#line 1273 "compiler_6-rc2.tab.c" /* yacc.c:1646  */
    break;

  case 7:
#line 93 "compiler_6-rc2.y" /* yacc.c:1646  */
    {  Create_declaration_variable_asm();}
#line 1279 "compiler_6-rc2.tab.c" /* yacc.c:1646  */
    break;

  case 8:
#line 94 "compiler_6-rc2.y" /* yacc.c:1646  */
    {  strcat(str_code.global_code,"\tsection .text\n"); }
#line 1285 "compiler_6-rc2.tab.c" /* yacc.c:1646  */
    break;

  case 9:
#line 100 "compiler_6-rc2.y" /* yacc.c:1646  */
    { Insert_symbol_table(&symbl,(yyvsp[0].string),0,"",0);}
#line 1291 "compiler_6-rc2.tab.c" /* yacc.c:1646  */
    break;

  case 10:
#line 102 "compiler_6-rc2.y" /* yacc.c:1646  */
    { Insert_symbol_table(&symbl,(yyvsp[0].string),1,"",0);}
#line 1297 "compiler_6-rc2.tab.c" /* yacc.c:1646  */
    break;


#line 1301 "compiler_6-rc2.tab.c" /* yacc.c:1646  */
      default: break;
    }
...
#line 184 "compiler_6-rc2.y" /* yacc.c:1906  */
		...
		while ( var_dec->next_node != NULL )
			...
			switch(var_dec->type){
				case 0:
					...
					snprintf(buffer,sizeof(buffer),"fmt_int_%s:db\"%d\"10,0\n",label_id,var-dec->value_int);
					strcat(str_code.global_code,buffer); //gera string de formato para  printf 
					printf("%s",buffer); 
					break;
				case 1:
					snprintf(buffer,sizeof(buffer),"%s: db \"%s\",0\n",var_dec->label_id,var_dec->value_str);
					strcat(str_code.global_code,buffer);
					snprintf(buffer,sizeof(buffer),"fmt_int_%s:db\"%s\"10,0\n",label_id,var-dec->value_char);
					strcat(str_code.global_code,buffer);
					printf("%s",buffer);
					break;
			}
...
void Set_variable(char * label_id, int value_int, char *value_str){
	int flag;
	flag = Search_symbol_table(symbl,label_id);
	if (flag ) {
		type_symbol_table * var_dec;
		var_dec =symbl;
		while(var_dec != NULL && (strcmp(var_dec->label_id,label_id)) )
			var_dec=var_dec->next_node;
...
void Read_variable(char * label_id){
	...
	if (var != NULL ) {
		switch(var->type){
			case 0:
				strcat(str_code.global_code,"MOV rdi, format\n");
				strcat(str_code.global_code," MOV rsi, [label_id]\n");
				strcat(str_code.global_code,"call scanf\n");
				strcat(str_code.global_code,"format: db \"%d\",0\n");
				
*/		

void Write_variable(char * label_id ){
	type_symbol_table * var_dec;
	var_dec = Search_symbol_table(label_id);
	if (var_dec != NULL ) {
		switch(var_dec->type){
			case 0:
				strcat(str_code.global_code,"PUSH rdb\n");
				snprintf(buffer,sizeof(buffer,"MOV rdi, fmt_int_%s\n",label_id));
				strcat(str_code.global_code,buffer);
				snprintf(buffer,sizeof(buffer),"MOV rsi [%s]",label_id);
				strcat(strcat.global_code,buffer);
				strcat(str_code.global_code,"call printf\n");
				strcat(str_code.global_code,"pop rdb\n");
			break;
			case 1:
				strcat(str_code.global_code,"PUSH rdb\n");
				//strcat(str_code.global_code,"MOV rdi,fmt_char\n");
				snprintf(buffer,sizeof(buffer,"MOV rdi, fmt_char_%s\n",label_id));
...
int main(int argc, char ** argv) {
	...
	strcpy(str_code.global_code,""); // inicialiando  o buffer de codigo
	...
	fp = fopen(argv[2],"w");
	if (fp != NULL ){
		fprintf(fp,"%s",str_code.global_code);
		flose(fp);
		fp = NULL;
	}
	//}
